...
import net.mcreator.jackmod.procedures.WhiskeyPlayerFinishesUsingItemProcedure;
...
public class WhiskeyItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		ItemStack retval = new ItemStack(JacksautismembodiedModItems.EMPTY_WHISKEY_BOTTLE.get());
