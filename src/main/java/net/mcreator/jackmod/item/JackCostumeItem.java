...
public abstract class JackCostumeItem extends ArmorItem {
	public JackCostumeItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{2, 99, 99, 99}[type.getSlot().getIndex()];
			}
	...
	public static class Helmet extends JackCostumeItem {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Modeljackhead(Minecraft.getInstance().getEntityModels().bakeLayer(Modeljackhead.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "jacksautismembodied:textures/entities/jackhead.png";
		}
