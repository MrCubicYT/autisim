...
import net.mcreator.jackmod.procedures.RifleRangedItemUsedProcedure;
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					RifleEntity entityarrow = RifleEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
					...
					RifleRangedItemUsedProcedure.execute(world, entity);
				}
			}
		}
	}
