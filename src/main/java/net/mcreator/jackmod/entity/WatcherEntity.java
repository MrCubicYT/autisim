...
import net.mcreator.jackmod.procedures.WatcherEntityIsHurtProcedure;
...
public class WatcherEntity extends Monster {
	public WatcherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JacksautismembodiedModEntities.WATCHER.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				RandomSource random = WatcherEntity.this.getRandom();
	...
	public boolean hurt(DamageSource source, float amount) {
		WatcherEntityIsHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		SpawnPlacements.register(JacksautismembodiedModEntities.WATCHER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
