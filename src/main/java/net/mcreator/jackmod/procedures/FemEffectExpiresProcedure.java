...
public class FemEffectExpiresProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event) {
		...
		if (_evt.getRenderer() instanceof PlayerRenderer) {
			...
			new com.kleiders.kleidersplayerrenderer.ExternalPlayerRenderer(new EntityRendererProvider.Context(dis, mc.getItemRenderer(), mc.getBlockRenderer(), dis.getItemInHandRenderer(), mc.getResourceManager(), mc.getEntityModels(), mc.font),
					new ResourceLocation("jacksautismembodied:textures/entities/no.png"))
